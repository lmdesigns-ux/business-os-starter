...
/**
 * sync-plan.js
 * Reads inputs/90-day-plan.md → parses → writes PortalData.plan in data/ycc-data.js or portal/data/portal-data.js.
 *
 * Usage:
 *   From `portal/`:  node skills/sync-plan.js
 *   From `template/`: node skills/sync-plan.js
 *
